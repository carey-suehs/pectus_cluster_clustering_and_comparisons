...
pc_boxplot(raw_data$fvc, tit = "CVF", pval = 0.0001)
pc_boxplot(raw_data$tlc, tit = "CPT", pval = 0.0001)
...
fvc_plot <- pc_boxplot(raw_data$fvc, tit = "FVC", pval = 0.0001)
tlc_plot <- pc_boxplot(raw_data$tlc, tit = "TLC", pval = 0.0001)
rt_plot <- pc_boxplot(raw_data$rv.tlc, tit = "RV/TLC", pval = 0.0001)
ff_plot <- pc_boxplot(raw_data$fev1.fvc, tit = "FEV1/FVC", pval = 0.058)
frc_plot <- pc_boxplot(raw_data$frc, tit = "FRC", pval = 0.162)
